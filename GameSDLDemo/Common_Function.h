...
const int POS_Y_START_MAIN_OBJ  = 300;
const int SPEED_MAIN_OBJECT     = 6;
...
const int SPEED_BULLET_THREATS          = 6;
...
static Mix_Chunk* g_sound_start[1];



static char g_name_bk_ground[] = {"bk2.png"};

static char g_name_main_obj[]           = {"plane80.png"};
...
static char g_name_start[]              = {"Undertale.wav"};

static char g_name_exp_threats[]        = {"exp.png"};
static char g_name_threats[]            = {"af1.png"};
static char g_name_bossthreat[]         = {"bossthreat.png"};
